...
public class HelpScreen extends JFrame {
	...
	public HelpScreen(JFrame beginScreen) {
		...
		background = new ImageIcon(getClass().getResource("/Images/volcanic-cone-Japan-Mount-Fuji.png"));
		JLabel bgIcon = new JLabel(background);
		helpFrame.setContentPane(bgIcon);
		helpLabel = new JLabel();
		helpLabel = new JLabel("<html> A trivia game is a fun and engaging way to test your knowledge on "
				...
				+ "challenge your brain and have fun at the same time. </html>", SwingConstants.CENTER);
