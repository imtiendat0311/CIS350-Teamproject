...
import javax.swing.SwingConstants;
	...
	public class AboutScreen extends JFrame {
		...
		public AboutScreen(JFrame beginScreen) {
			...
			aboutFrame.addWindowListener(new java.awt.event.WindowAdapter() {
			...
			backGroundIcon = new ImageIcon(getClass().getResource("/Images/volcanic-cone-Japan-Mount-Fuji.png"));
			...
			aboutLabel = new JLabel("<html><p>This program is made by:<br/> Duc Pham <br/> Harrison VanderZee <br/> Leo Ho <br/> CIS 350 PROJECT WINTER 2023</p></html>", SwingConstants.CENTER);
