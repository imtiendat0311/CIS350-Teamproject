...
// ActionEvent actionEvent = new ActionEvent(startGameButton,
// ActionEvent.ACTION_PERFORMED, "");
// startGameButton.getActionListeners()[0].actionPerformed(actionEvent);
// assertFalse("Frame is not invisible after clicking start game button",
...
// ActionEvent actionEvent = new ActionEvent(helpButton,
// ActionEvent.ACTION_PERFORMED, "");
// helpButton.getActionListeners()[0].actionPerformed(actionEvent);
// assertFalse("Frame is not invisible after clicking help button",
// beginScreen.getFrame().isVisible());
// }
...
// ActionEvent actionEvent = new ActionEvent(aboutButton,
// ActionEvent.ACTION_PERFORMED, "");
// aboutButton.getActionListeners()[0].actionPerformed(actionEvent);
// assertFalse("Frame is not invisible after clicking about button",
// beginScreen.getFrame().isVisible());
// }
...
// assertFalse("Some issue happened, please check this function again",
...
// assertTrue("Some issue happened, please check this function again",
// startScreen.getIsCorrect());
